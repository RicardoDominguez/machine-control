...
def loadPickle(name):
    ...
    Arguments:
        name (str): Path to pickled object.
...
class BNN:
    ...
    Arguments:
        params (DotMap):
            ...
            .num_networks (int): (optional)
                The number of networks in the ensemble. Defaults to 1.
            ...
            .load_model (bxool): (optional)
                If True, model will be loaded from the model directory, assuming
                that the files are generated by a model of the same name. Defaults to False.
            .sess (tf.Session/None):
                The session that this model will use. If None, creates a session
                with its own associated graph. Defaults to None.
    """
    ...
    def predict(self, inputs, factored=False, *args, **kwargs):
        ...
        inputs is 2D, factored=True:
            Each row is treated as an input vector.
        ...
        inputs is 3D, factored=True/False:
            Each row in the last dimension is treated as an input vector.
