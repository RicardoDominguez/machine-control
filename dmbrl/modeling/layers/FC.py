...
class FC:
    ...
    def __init__(self, output_dim, input_dim=None,
        ...
        self.activation = activation # The activation function applied on the outputs.
        self.weight_decay = weight_decay # The rate of weight decay applied to the weights of this layer.
        self.ensemble_size = ensemble_size # The number of networks in the ensemble within which this layer will be used.
